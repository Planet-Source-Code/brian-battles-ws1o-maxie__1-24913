VERSION 5.00
Begin VB.Form frmLoadToSystray 
   ...
   EndProperty
   Icon            =   "frmLoadToSystray.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   975
   ScaleWidth      =   5565
   ...
   End
End
Attribute VB_Name = "frmLoadToSystray"
...
'
'    'popup menu Exit command
'
'    On Error GoTo Err_mPopExit_Click
'
'    Unload Me
'
'Exit_mPopExit_Click:
...
'            Resume Next
'        Case Else
'            MsgBox "Error Code: " & Err.Number & vbCrLf & vbCrLf & Err.Description & vbCrLf & vbCrLf & "during mPopExit_Click, in frmLoadToSystray", vbInformation, "Advisory"
'            Resume Exit_mPopExit_Click
'    End Select
'
'End Sub
